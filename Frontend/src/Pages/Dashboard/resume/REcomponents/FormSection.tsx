...
import EducationP from "./forms/Education";
...
const FormSection1 = () => {
  ...
  return (
    <JobAnalysisProvider>
      {/* Navigation Buttons */}
      <div className="flex gap-2 mb-6 justify-end text-stone-800">
        {activeFormIndex > 1 && (
          <Button
            size="sm"
            variant="outline"
      ...
      {/* Stepper */}
      <div className="md:flex flex-col mb-6 hidden">
      ...
      <div className="form-stepper text-stone-800">
        ...
        {activeFormIndex === 5 && <EducationP enableNext={setEnableNext} />}
